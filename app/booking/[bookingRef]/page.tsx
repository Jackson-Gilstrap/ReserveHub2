        ...
        <>
          ...
          <section className="bg-[#FDFDFD] border border-[#E0E0E0] rounded-lg mt-4 p-6 shadow-md max-w-3xl mx-auto">
            ...
            <ol className="list-decimal list-inside text-[#212529] space-y-2">
              <li>
                Bring your Identity Protection Pin &#40;IP Pin&#41; if you have
                it
              </li>
              <li>
                If your filing and have dependent&#40;s&#41; make sure to bring
                their social security card
              </li>
              <li>
                If you have ObamaCare/Affordable Care Act &#40;ACA&#41; or
                Medicare.{" "}
